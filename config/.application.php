 ...
 * 
 * Внимание: после установки приложения базовые значения параметров будут 
 * изменены (см. ".application.sample.php").
 * 
...
return [
     ...
     * унифицированного (unified) конфигуратора приложения `Rg::$app->unifiedConfig->language`.
     */
    'language' => 'ru',
     ...
     * конфигураторе приложения `Rg::$app->unifiedConfig->bootstrap`.
     * 
    ...
    'edition' => [
        ...
        'number'       => '1.0',
        'resource'     => 'https://rosgear.ru/cms/',
        'docsResource' => 'https://rosgear.ru/docs/cms-std/1.x/',
        'date'         => '01/01/2026'
    ]
];
